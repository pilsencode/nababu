...
public class EntryPointActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJoinGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(EntryPointActivity.this, "Not implemented yet", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void hostGame(View view) {
        if (0 == txtUserName.getText().toString().trim().length()) {
            Toast.makeText(EntryPointActivity.this, "Username cannot be empty", Toast.LENGTH_LONG).show();
        } else {
